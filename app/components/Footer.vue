<template>
  <footer
    class="border-t border-[#e6dbdd] dark:border-[#3d2025] bg-white dark:bg-background-dark px-6 py-12"
  >
    <div
      class="mx-auto flex max-w-[1200px] flex-col items-center justify-between gap-8 md:flex-row"
    >
